...
fun ChatScreen(
    ...
    // ✅ Récupération du userId via DataStore (Flow)
    val currentUserIdNullable by dataStore.userIdFlow.collectAsState(initial = null)
    val currentUserId = currentUserIdNullable ?: ""
