...
// ==================================================
    ...
    @GET("posts/{id}")
    suspend fun getClubPost(@Path("id") id: String): ClubPostDto
    ...
    // Club notifications (legacy)
    @GET("notifications/club/{clubId}")
    suspend fun getClubNotifications(@Path("clubId") clubId: String): List<Notification>
  ...
  // ---------------------------------------------------------
    ...
    // MESSAGING (Unified)
    // ==================================================
    @GET("messages/unified-conversations")
    suspend fun getUnifiedConversations(@Query("userId") userId: String): List<UnifiedConversationDto>

    @GET("utilisateurs/contacts")
    suspend fun getContacts(@Query("userId") userId: String): List<User>
