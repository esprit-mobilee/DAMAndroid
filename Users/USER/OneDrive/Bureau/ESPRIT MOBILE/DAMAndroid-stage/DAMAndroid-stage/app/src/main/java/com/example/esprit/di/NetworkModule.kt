...
object NetworkModule {
    ...
    ): Interceptor = AuthInterceptor(dataStoreManager)
    ...
    // 📦 Custom Gson instance with Location deserializer
    @Provides
    @Singleton
    fun provideGson(): com.google.gson.Gson =
        com.google.gson.GsonBuilder()
            .registerTypeAdapter(
                com.example.esprit.model.Location::class.java,
                com.example.esprit.model.LocationDeserializer()
            )
            .create()
