        ...
        Scaffold(
            ...
            Column(
                ...
                FlowRow(
                    ...
                    ActionGridItem("Utilisateurs") { /* TODO */ }
                    ActionGridItem("Annonces") { /* TODO */ }

                    // 👉 this one now navigates to admin internships
                    ActionGridItem("Stages") {
                        onNavigateStages()
                    }

                    ActionGridItem("Événements") { /* TODO */ }

                    ActionGridItem("Clubs & vie étudiante") {
